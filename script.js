...
var questions = [
    {
      ...
      multiChoice: ["cascading style sheet", "central style sheet", "central system storage", "cascading system sheet"],
      answer: "cascading style sheet"
    },
  
    {
      title: "What is the correct way to close a <tag>?",
      multiChoice: ["<close>", "(close)", "<close/>", "</close>"],
      answer: "</close>"
    },
  
    {
      title: "If code was a class in html how would you target it in css?",
      multiChoice: ["code", ".code", "code.", "./code"],
      answer: ".code"
    },
  
    {
      title: "Do you need a closing doctype html tag?",
      multiChoice: ["Yes", "No"],
      answer: "No"
    },
  
    {
      title: "What makes the webpage have animations?",
      multiChoice: ["html", "css", "javascript"],
      answer: "javascript"
    }
  ];